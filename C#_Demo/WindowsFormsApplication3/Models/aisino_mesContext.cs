...
using WindowsFormsApplication3.Models.Mapping;
...
namespace WindowsFormsApplication3.Models
{
    public partial class aisino_mesContext : DbContext
    {
        ...
        public DbSet<InOutMaster> InOutMasters { get; set; }
        public DbSet<InOutStepInfo> InOutStepInfoes { get; set; }
        ...
        public DbSet<SettlementMaster> SettlementMasters { get; set; }
        ...
        public DbSet<WeightBridge> WeightBridges { get; set; }
        public DbSet<WeightFlowRate> WeightFlowRates { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new InOutMasterMap());
            modelBuilder.Configurations.Add(new InOutStepInfoMap());
            ...
            modelBuilder.Configurations.Add(new SettlementMasterMap());
            ...
            modelBuilder.Configurations.Add(new WeightBridgeMap());
            modelBuilder.Configurations.Add(new WeightFlowRateMap());
        }
    }
}
